...
//init always returns id. initWithCoder is always used with storyboard
- (id)initWithCoder:(NSCoder *)aDecoder
{
    self = [super initWithCoder:aDecoder];
    //make sure we arent doing anything to self if there is a self
    if (self)
    {
        tweets = @[
                   @{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //cell indentifier that will be changed id switch
    NSString * reuseID = @"cell";
    
    //style for table cell that will be changed in switch
    //enum, C primitive, doesnt need *
...
//    
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseID];
        ...
        //dequed cell equals nil, and if nil, style it
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    //getting dictionary for the tweet
    NSDictionary * tweet = tweets[indexPath.row];
